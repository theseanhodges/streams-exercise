...
class StreamProcessor(object):
   ...
   def process(self):
      """
      Process the stream and return the number of 2 digit numbers required to reach a total of 200.
      Will stop processing if:
       - it encounters a non-integer
       - it reaches 10 two-digit numbers
       - it reaches EOF
